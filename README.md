# [SOLVED] Docker-Driver-Failed-Programming-External-Connectivity-On-En
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/docker-driver-failed-programming-external-connectivity-on-en)
>
...
Try stopping and restarting the nginx service before running the docker command, or use the --restart flag to restart the container after it exits.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/docker-driver-failed-programming-external-connectivity-on-en)**
